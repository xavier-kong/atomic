...
export type HabitsResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['Habits'] = ResolversParentTypes['Habits']
> = ResolversObject<{
...
> = ResolversObject<{
    allHabits?: Resolver<
        Array<Maybe<ResolversTypes['Habits']>>,
        ParentType,
        ContextType
    >;
    allProgress?: Resolver<
        Array<Maybe<ResolversTypes['Progress']>>,
        ParentType,
        ContextType,
        RequireFields<QueryAllProgressArgs, 'habit_uid'>
    >;
}>;
